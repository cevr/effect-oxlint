...
export const noFromNullableCoalesce = Rule.define({
  ...
  meta: Rule.meta({
    type: "suggestion",
    description: "Redundant nullish coalescing in Option.fromNullable. Pass the value directly.",
  }),
  create: function* () {
    ...
    return {
      CallExpression: (node) => {
        ...
        const isFromNullable =
          AST.isCallOf(ce, "Option", "fromNullable") || AST.isCallOf(ce, "Option", "fromNullishOr");
