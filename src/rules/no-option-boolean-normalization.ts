      ...
      CallExpression: (node) => {
        ...
        for (const prop of opts.properties) {
          if (
            ...
            continue;
          const key = (prop as unknown as Record<string, unknown>)["key"] as unknown as Record<
            string,
            unknown
          > | null;
          const value = (prop as unknown as Record<string, unknown>)["value"] as unknown as Record<
            string,
            unknown
          > | null;
